...
export const MockDiscordUI = ({ children }: PropsWithChildren) => {
  return (
    ...
    >
      {/*Server list */}
      <div
        className="hidden sm:flex w-[77px] bg-[#202225]
       py-3 gap-y-3 flex-col items-center"
      >
        <div
          className="size-12 bg-discord-background rounded-2xl flex items-center justify-center
          mb-2 hover:rounded-xl transition-all duration-200"
        >
          <Icons.discord className="size-3/5 text-white"></Icons.discord>
        </div>
        ...
        {Array.from({ length: 5 }, (_, i) => (
          <div
            key={i}
            className="size-12 bg-discord-background rounded-3xl flex items-center
            justify-center hover:rounded-xl transition-all duration-200 hover:bg-discord-brand-colour cursor-not-allowed"
          >
        ...
        <div
          className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center
          justify-center hover:rounded-xl transition-all duration-200 hover:bg-[#3ba55c] cursor-not-allowed"
        >
        ...
        <div className="flex-1 overflow-y-auto pt-4">
          <div className="px-2 mb-4">
            ...
            <div
              ...
              hover:bg-[#393c43] text-[#dcddde] cursor-not-allowed"
            >
              <InboxIcon className="mr-4 size-8 text-[#b9bbbe]" />
              <span className="font-medium text-sm">Nitro</span>
            </div>
          </div>

          <div className="px-2 mb-4">
            <h3 className="text-xs font-semibold text-[#849297] px-2 mb-2 uppercase">
              Direct Messages
            </h3>
            ...
            <div className="my-1 space-y-px">
              {Array.from({ length: 4 }, (_, i) => (
                ...
                rounded text-gray-600 cursor-not-allowed"
                >
        ...
        <div className="h-16 bg-[#36393f] flex items-center px-4 shadow-sm border-b border-[#202225]">
          ...
          <div className="flex items-center">
            <div className="relative">
              ...
              />
              <div
                className="absolute bottom-0 right-3 size-3
              bg-green-500 rounded-full border-2 border-[#36393f]"
              />
            </div>
