...
export const PaymentSuccessModal = () => {
  ...
  const isPaymentCompleted = plan === Plan.PRO;
  ...
  return (
    <Modal
      ...
      onClose={handleClose}
      className="px-6 pt-6" // REMOVE h-full here
      preventDefaultClose={!isPaymentCompleted}
    >
      <div className="flex flex-col items-center h-full">
        {" "}
        {/*Add h-full to the parent container*/}
          ...
          <>
            <div className="relative aspect-video border border-gray-200 w-full overflow-hidden rounded-lg bg-gray-50">
              <img
                ...
                className="object-cover" //removed h-full and w-full here.
                alt="Payment Success"
              />
            </div>{" "}
            {/*Move div to wrap only img*/}
